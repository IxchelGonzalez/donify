...
public class GestionEntregas extends JPanel {
     ...
     * correspondiente: la de la sesion si el usuario es de tipo institucion, o la
     * seleccionada en comboAsociacion en caso contrario. Si no hay institucion
     * seleccionada, el combo queda vacio.
     */
